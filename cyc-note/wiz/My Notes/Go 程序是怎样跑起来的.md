---
Title: "Go 程序是怎样跑起来的"
Url: "https://mp.weixin.qq.com/s/Rewl0DKnq6CY53m5D3G2qw"
Author: ""
Origin: "WizNote"
Description: ""
Tags: []
Created: "2019-07-03 16:19:43"
Cover: ""
WizGuid: "481cb5f6-f921-4aee-a16a-467632642c7e"
WizType: ""
WizLocation: "/My Notes/"
WizDataMd5: "d3eec2cddff29b55fc9173efbb912756"
Modified: "2019-07-03 16:19:43"
...
功能介绍 一线互联网工程师死磕技术的心路历程、经验教训。欢迎围观！
...
在开始本文之前，先推荐一下王晶大佬（以前在滴滴）的博客——《面向信仰编程》，他的 Go 编译系列文章，非常有深度，直接深入编译器源代码，我是看了很多遍了。博客链接可以从参考资料里获取。
...
![[attachments/640_11.jpg]]

bin 目录下面：

![[attachments/640_12.png]]

pkg 目录下面：

![[attachments/640_13.jpg]]

Go 工具目录如下，其中比较重要的有编译器 `compile`，链接器 `link`：

![[attachments/640_14.jpg]]
...
```
go install src/main.go或者go install util
```
...
![[attachments/640_23.jpg]]

饶全成

![[attachments/pic_mp_app4290ba.png]] **扫一扫下载订阅号助手，用手机发文章**  [赞赏](##)

长按二维码向我转账

  ![[attachments/pic_reward_qrcode.2x42f400.png]]
...
![[attachments/pic_haokan4516f7.png]]
