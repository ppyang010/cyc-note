...
Url: https://juejin.cn/post/7671964740780785670?utm_source=gold_browser_extension
Author: cxuanAI
Origin: 掘金
Description: 各位小伙伴们大家好，我是 cxuan。 今天我们来聊一下 Pi ，Pi 这个 Agent 我也是想写很久了。 如果你刚接触 Pi，就暂且可以先把它理解成一个运行在 CLI 里的 Coding Agen
Tags:
  - 程序员
  - 人工智能
  - Agnet
Created: 2026-08-27 10:10:10
Cover: https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806060937325.png
---
...
![image-20260806060937325](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806060937325.png)

一个最基础的 Pi session 的工作流如下：

![image-20260806084506363](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806084506363.png)
...
![Pi 的核心、Skill、Extension、Package 与项目规则](https://cdn.jsdelivr.net/gh/doggaifan/picbed/14-pi-ecosystem-illustration.png)
...
```
css 代码解读复制代码npm install -g --ignore-scripts @earendil-works/pi-coding-agent
```

进入项目后启动：

```bash
bash 代码解读复制代码cd your-project
pi
```

就完事儿了。

![image-20260805230847199](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260805230847199.png)
...
```bash
bash 代码解读复制代码/login       登录模型供应商或订阅
/model       选择模型
...
![Pi、Codex CLI、Claude Code 和 Gemini CLI 怎么选](https://cdn.jsdelivr.net/gh/doggaifan/picbed/15-cli-choice-illustration.png)
...
![image-20260806072142293](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806072142293.png)
...
```json
json 代码解读复制代码"apiKey": "!security find-generic-password -a lx -s pi-deepseek-api-key -w"
```

把 key 存进钥匙串就一行：

```csharp
csharp 代码解读复制代码security add-generic-password -a lx -s pi-deepseek-api-key -w 'sk-你的key'
```
...
![image-20260806080058068](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806080058068.png)
...
![image-20260806083124683](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806083124683.png)

DeepSeek-v4-Flash 的完整报告如下。

![image-20260806075435405](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806075435405.png)

这次排查过程还是真香，一顿排查花了 20 M token，费用才不到 1 块钱。而且速度还快。

![image-20260806073517971](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806073517971.png)

我想到了之前有人在知乎上提到了一个问题，我的回答是：

![image-20260806090208547](https://cdn.jsdelivr.net/gh/doggaifan/picbed/image-20260806090208547.png)
...
![ea1e0a9cb93c8c44b807c678415bf5b9](https://cdn.jsdelivr.net/gh/doggaifan/picbed/ea1e0a9cb93c8c44b807c678415bf5b9.jpg)
