---
id: "648873532"
title: "Java实现简单的RPC框架"
author: "小九"
type: zhihu-article
source: "https://zhuanlan.zhihu.com/p/648873532"
created: "2023-08-10 11:04"
updated: "2023-08-10 11:04"
collected: "2023-08-10 11:04"
...
| 12345 | public interface HelloService { String sayHi(String name); } |
| ----- | ----- |
...
| 1234567 | public class HelloServiceImpl implements HelloService { public String sayHi(String name) { return "Hi, " + name; } } |
| ----- | ----- |
...
| 1234567891011 | public interface Server { public void stop(); public void start() throws IOException; public void register(Class serviceInterface, Class impl); public boolean isRunning(); public int getPort();} |
| ----- | ----- |
...
| 123 | regeist service HelloServicestart serverHi, test |
| ----- | ----- |
