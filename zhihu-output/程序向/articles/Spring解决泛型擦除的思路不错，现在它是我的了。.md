...
author: "why技术"
type: zhihu-article
source: "https://zhuanlan.zhihu.com/p/677880235"
created: "2024-01-15 12:27"
updated: "2024-01-15 12:27"
collected: "2024-01-15 12:27"
...
> [https://docs.spring.io/spring-framework/reference/core/beans/context-introduction.html#context-functionality-events-generics](https://link.zhihu.com/?target=https%3A//docs.spring.io/spring-framework/reference/core/beans/context-introduction.html%23context-functionality-events-generics)  
...
关于 @EventListener 注解的原理和源码解析，我之前写过一篇相关的文章：**[《扯下@EventListener这个注解的神秘面纱。》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/RSgd_bWH_oPQUDU3IsJEOQ)**
...
这个地方再往下写，就是我前面我提到的这篇文章中我写过的内容了**[《扯下@EventListener这个注解的神秘面纱。》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/RSgd_bWH_oPQUDU3IsJEOQ)**。
