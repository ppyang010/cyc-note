---
id: "3123427382"
title: "python asyncio的设计晦涩难懂，一点也不python，是做毁了吗？"
author: "PP鲁"
type: zhihu-answer
source: "https://www.zhihu.com/question/451397804/answer/3123427382"
created: "2023-07-18 08:26"
updated: "2023-07-18 08:26"
collected: "2023-07-18 08:26"
downloaded: "2026-08-16"
---
不只是 Python 的 asyncio ，其他异步编程或者协程都不容易理解，比如异步使用最多的 JavaScript 或者 TypeScript 之类，也是需要花一些精力去理解。因为异步编程与同步编程有很大的区别。当然如果没有历史包袱，一开始就学的是异步编程，可能反而更容易理解

正好看了 BBC 团队撰写的一个 asyncio 专栏，加上了一些我自己的理解，写了一个这样的长文，供大家参考。

**[https://bbc.github.io/cloudfit-public-docs/asyncio/asyncio-part-1.html](https://link.zhihu.com/?target=https%3A//bbc.github.io/cloudfit-public-docs/asyncio/asyncio-part-1.html)**

**[https://bbc.github.io/cloudfit-public-docs/asyncio/asyncio-part-2.html](https://link.zhihu.com/?target=https%3A//bbc.github.io/cloudfit-public-docs/asyncio/asyncio-part-2.html)**

**也可以在我的博客上阅读：**[https://lulaoshi.info/python/asyncio/basics.html](https://link.zhihu.com/?target=https%3A//lulaoshi.info/python/asyncio/basics.html)
...
![Subroutines v.s. Coroutines](images/443_001.jpg)
...
![程序刚开始：执行 main() 函数](images/443_002.jpg)
...
![执行 some_other_value = a_func(some_value)，进行函数调用](images/443_005.jpg)
...
![执行 return x-2，从 a_func() 返回到 main()](images/443_006.jpg)
...
![Event Loop 有多个 Task，每个 Task 维护一个堆栈](images/443_007.jpg)
...
刚才的那部分我们介绍了协程调用相关基础概念。这一部分开始使用 asyncio 进行异步编程。
...
换个角度思考，`await` 一个 coroutine object，有点像主动去调用一个传统意义上的同步函数。这个 coroutine 对象里的代码段包含了异步的代码。回忆**[上一节](https://www.zhihu.com/question/basics.md)**，我们提到，异步代码是以 Task 的形式去运行，被 Event Loop 管理和调度的，Task 可以被暂停和恢复，每个 Task 有自己调用栈。所以，虽然调用一个同步函数和 `await` 一个 coroutine 对象有点像，但是 coroutine 对象中的异步代码是可以被暂停和恢复的。这也是同步函数和异步函数的重要区别。
...
我们重点介绍异步程序与同步程序的区别在于：程序以 `Task` 的形式放到 Event Loop 中，Event Loop 管理多个 `Task`，唤醒某个 `Task` 或者暂停某个 `Task` 。
...
-   **[https://bbc.github.io/cloudfit-public-docs/asyncio/asyncio-part-2.html](https://link.zhihu.com/?target=https%3A//bbc.github.io/cloudfit-public-docs/asyncio/asyncio-part-2.html)**
-   **[https://www.pythontutorial.net/python-concurrency/python-asyncio-create\_task/](https://link.zhihu.com/?target=https%3A//www.pythontutorial.net/python-concurrency/python-asyncio-create_task/)**
-   **[https://docs.python.org/3/library/asyncio-task.html](https://link.zhihu.com/?target=https%3A//docs.python.org/3/library/asyncio-task.html)**
-   **[https://stackoverflow.com/questions/56729764/asyncio-sleep-vs-time-sleep](https://link.zhihu.com/?target=https%3A//stackoverflow.com/questions/56729764/asyncio-sleep-vs-time-sleep)**