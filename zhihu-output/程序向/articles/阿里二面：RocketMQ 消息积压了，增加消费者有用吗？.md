---
id: "480762345"
title: "阿里二面：RocketMQ 消息积压了，增加消费者有用吗？"
author: "上弦月"
type: zhihu-article
source: "https://zhuanlan.zhihu.com/p/480762345"
created: "2022-03-14 15:32"
updated: "2022-03-14 15:32"
collected: "2022-03-14 15:32"
...
如果这个接口返回结果必须要处理，并且不能缓存，可以把拉取到的消息存入本地然后给 Broker 直接返回 CONSUME\_SUCCESS。等外部系统恢复正常后再从本地取出来进行处理。
...
[阿里二面：RocketMQ 消息积压了，增加消费者有用吗？](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/iultj1KtBSWxDbcYrZsJOg)